...
-   This predictor value is used to split the data into two groups based on the threshold of 267,228. 
...
# Create confusion matrix for classification tree
conf_mat_tree4 <- confusionMatrix(predict_bagged, test)
conf_mat_tree4
...
# Create confusion matrix for classification tree
conf_mat_tree5  <- confusionMatrix(as.factor(pred_RFSGB), test$type, positive = "0")
